...
/*
AuthApiService Retrieve auth config
Retrieve authentication options
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return InlineResponse2003
*/
func (a *AuthApiService) AuthConfigPost(ctx context.Context) (InlineResponse2003, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/auth.config"
...
/*
AuthApiService Retrieve auth
Retrieve authentication details for the current API key
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return InlineResponse2002
*/
func (a *AuthApiService) AuthInfoPost(ctx context.Context) (InlineResponse2002, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
