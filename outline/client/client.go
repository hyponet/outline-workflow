...
// APIClient manages communication with the Outline API API v0.1.0
...
type APIClient struct {
	...
	FileOperationsApi *FileOperationsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.FileOperationsApi = (*FileOperationsApiService)(&c.common)
